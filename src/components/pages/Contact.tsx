...
const Contact = () => {
  return (
    <main className="grow p-4 sm:p-8 lg:p-12">
      <div className="max-w-4xl mx-auto flex flex-col gap-12">
        {/* Header */}
        <div className="text-center space-y-3">
          <TextAnimate animation="blurInUp" by="text" className="text-4xl sm:text-5xl font-black text-black dark:text-white tracking-tight">
            Get in Touch
          </TextAnimate>
          <TextAnimate animation="blurInUp" by="word" className="text-gray-600 dark:text-[#9db0b9] max-w-xl mx-auto text-base">
