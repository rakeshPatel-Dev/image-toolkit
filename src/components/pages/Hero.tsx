...
const Home = () => {
  return (
    <div className="min-h-screen  text-gray-800 dark:text-gray-100 flex flex-col transition-colors duration-300">
      ...
      <Header/>
      {/* Hero Section */}
      <main className="grow flex flex-col items-center justify-center px-4 py-16 text-center">
        <div className="mb-2">
        <ComingSoon/>
        </div>

        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-gray-900 dark:text-white transition-colors duration-300">
          Your All-in-One Image Toolkit
        </h2>
        <p className="text-gray-600 dark:text-gray-400 mb-10 max-w-md transition-colors duration-300">
