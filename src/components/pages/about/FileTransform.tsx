    ...
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <TextAnimate animation="blurInUp" by="text" as={h2} className="text-gray-900 dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em] pb-3">
            Change File Type
          </TextAnimate>
          <TextAnimate animation="blurInUp" by="word" as={p} className="text-gray-800 dark:text-gray-300 text-base font-normal leading-normal pb-4">
